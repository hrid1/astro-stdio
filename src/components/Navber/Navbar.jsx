    ...
    <nav className="flex items-center justify-between w-full relative h-auto px-2.5">
      ...
      <ul className="items-center gap-[24px] text-[1rem] text-[#424242] md:flex hidden">
        ...
        <li className=" transition-all duration-500 cursor-pointer hover:text-[#000] capitalize flex items-center gap-[3px] group relative font-medium">
          about
          <article className="p-6 bg-black text-white  boxShadow w-[500px] absolute top-[50px] z-[-1] left-[-100px] group-hover:translate-y-0 translate-y-[-20px] group-hover:opacity-100 opacity-0 group-hover:z-30 transition-all duration-300">
            <div className="grid grid-cols-2">
              <ul className="flex flex-col gap-[7px] text-white">
                <li className="flex items-center gap-[7px] hover:text-[#000] transition-all duration-300">
                  <BsArrowRight className="text-white text-[0.9rem]" /> Company
                  Details
                </li>
                <li className="flex items-center gap-[7px] hover:text-[#000] transition-all duration-300">
        ...
        <li className="transition-all duration-500 cursor-pointer hover:text-[#000] capitalize group relative flex items-center gap-[3px] font-medium">
          pages
          <article className="p-6 bg-black  w-[1000px] absolute top-[50px] z-[-1] left-[-500px] group-hover:translate-y-0 translate-y-[-20px] group-hover:opacity-100 opacity-0 group-hover:z-30 transition-all duration-300">
        ...
        <li className="transition-all duration-500 cursor-pointer hover:text-[#000] capitalize group relative flex items-center gap-[3px] font-medium">
          services
          <article className="p-6 bg-black  w-[320px] absolute top-[50px] z-[-1] left-[-150px] group-hover:translate-y-0 translate-y-[-20px] group-hover:opacity-100 opacity-0 group-hover:z-30 transition-all duration-300">
            <div className="grid ">
              <ul className="flex flex-col gap-[7px] text-[#fff]">
                <li className="flex items-center gap-[7px] text-xl transition-all duration-300">
                  Company Details
                </li>
                <li className="flex items-center gap-[7px] hover:text-xl transition-all duration-300">
                  Company Location
                </li>
                <li className="flex items-center gap-[7px] hover:text-xl transition-all duration-300">
                  Team Members
